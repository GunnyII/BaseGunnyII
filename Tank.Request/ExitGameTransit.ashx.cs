    ...
    public class ExitGameTransit : IHttpHandler
    {
        ...
        public string LoginURL
        {
            get
            {
                ...
                return System.Configuration.ConfigurationManager.AppSettings[login];
        ...
        //        return System.Configuration.ConfigurationManager.AppSettings["SiteEffective"];
        //    }
        //}
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    url = System.Configuration.ConfigurationManager.AppSettings["ExitURL"];
                }
