    ...
    public class StartGameAction : IAction
    {
        ...
        public void Execute()
        {
            if (m_room.CanStart())
            {
                ...
                else if (m_room.RoomType == eRoomType.Dungeon)
                {
                    ...
                    //StartGame(game);
                   m_room.m_baseGames = GameMgr.StartPVEGame(m_room.RoomId, matchPlayers, m_room.MapId, m_room.RoomType, m_room.GameType, m_room.TimeMode, m_room.HardLevel, m_room.LevelLimits);
