...
namespace Bussiness
{
    public class CountBussiness
    {
        ...
        public static string ConnectionString
        {
            get
            {
                //return ConfigurationManager.AppSettings["countDb"];
        ...
        public static int SubID
        {
            get
            {
                //return int.Parse(ConfigurationManager.AppSettings["SubID"]);
                return _subID;
            }
        }
        ...
        public static bool CountRecord
        {
            get
            {
                //return bool.Parse(ConfigurationManager.AppSettings["CountRecord"]);
                return _conutRecord;
            }
        }
